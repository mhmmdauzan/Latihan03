package id.ac.poliban.mi.auzan.latihan03;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        //evemt listener & event handler
        //menggunakan lambda expression
        btArsenal.setOnClickListener(view -> Toast.makeText(this, "Arsenal : 1878", Toast.LENGTH_SHORT).show());
